						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ url('MarkAsRead_all') }}">تعيين قراءة الكل</a></span>
										</div>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<!-- <a class="dropdown-item" href="{{route('login')}}"><i class="bx bx-log-out"></i> logout</a> -->
